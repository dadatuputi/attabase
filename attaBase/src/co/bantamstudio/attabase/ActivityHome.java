...
public class ActivityHome extends Activity {
	...
	// Animations
	private Animation leftToMiddle = horizontalAnimation(-1.0f, RIGHT);
	private Animation middleToRight = horizontalAnimation(0.0f, RIGHT);
	private Animation rightToMiddle = horizontalAnimation(+1.0f, LEFT);
	private Animation middleToLeft = horizontalAnimation(0.0f, LEFT);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCurrentBase = prefs.getInt(AttaBaseContract.PREFS_HOME_BASE_INT, NO_BASE);
        mCurrentService = prefs.getInt(AttaBaseContract.PREFS_HOME_SERVICE_INT, NO_BASE);
    }
    ...
    protected void onStart() {
        ...
        if (va.getChildCount() == 0){
	        if (mCurrentBase > 0){
	        	...
	        	transitionToNewView(VIEW_TYPE.VIEW_SERVICES, NO_BASE);
	        }  
        }
    }
	...
	private void transitionToNewView(VIEW_TYPE vt, int index){
    	...
    	switch (vt) {
    	case VIEW_SERVICES:
    		mCurrentService = NO_SERVICE;
    		setCursorAdapterServicesAll();
        	ll = populateBaseListView(NO_SERVICE, NO_BASE);
        	va.addView(ll);
        	va.showNext();
        	break;
    	case VIEW_BASES:
        	...
        	ll = populateBaseListView(mCurrentService, NO_BASE);
        	va.addView(ll);
        	va.showNext();
        	break;
    	case VIEW_BASE:
    ...
    private void setCursorAdapterBaseLocationsAll(int base){
        ...
        mAdapter = new SimpleCursorAdapter(this, R.layout.activity_home_entry, baseLocations, columns, to);
    }
    ...
    private void setCursorAdapterServicesAll(){
        ...
        mAdapter = new SimpleCursorAdapter(this, R.layout.activity_home_entry, services, columns, to);
    }
    ...
    private void setCursorAdapterService(int service){
        ...
        int to[] = new int[] {R.id.name_entry};
        mAdapter = new SimpleCursorAdapter(this, R.layout.activity_home_entry, bases, columns, to);
    }
//    @SuppressWarnings("deprecation")
...
//        String[] columns = new String[] {AttaBaseContract.LocationSchema.COLUMN_NAME_LOCATION_NAME, AttaBaseContract.LocationTypeSchema.COLUMN_NAME_DIRECTORY_NAME};
//        int to[] = new int[] {R.id.name_entry, R.id.name_entry_sub};
//        mAdapter = new SimpleCursorAdapter(this, R.layout.activity_home_entry, location, columns, to);
//    }
    ...
    private void setCursorAdapterBaseLocationTypes(int base){
        ...
        int to[] = new int[] {R.id.name_entry};
        mAdapter = new SimpleCursorAdapter(this, R.layout.activity_home_entry, baseLocationTypes, columns, to);
    }
